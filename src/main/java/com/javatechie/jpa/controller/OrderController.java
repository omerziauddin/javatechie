...
public class OrderController {
    ...
    //method to save customer object as well as its list of products
    ...
    @GetMapping("/getEmailPrice")
    public List<OrderResponse> getEmailPrice(){
        return customerRepository.getEmailPrice();
    }
}
